...
class App {
    ...
    fun Content() {
        ...
        MaterialTheme {
            ...
            LaunchedEffect(faceCaptured.value) {
                Logger.e("vishnu", faceCaptured.value?.embedding.toString())
            }
                    ...
                    if (!showCamera)
                        ...
                        SelfieCheck(
                            ...
                            onVerificationComplete = {
                                ...
                                faceCaptured.value =
                                    getFaceEmbeddings(
                                        image = decodeImage(viewModel.capturedFaceImage!!.toByteArray()), // todo
                                        model = faceMatchLiteRtModel
                                    )

//                                faceCaptured.value?.embedding?.forEach {
//                                    Logger.e("vishnu", "Content: ${it.toString()}")
//                                }
