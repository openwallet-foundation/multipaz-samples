...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final MultipazLibraryAccessors laccForMultipazLibraryAccessors = new MultipazLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>multipaz</b>
     */
    public MultipazLibraryAccessors getMultipaz() {
        return laccForMultipazLibraryAccessors;
    }
    ...
    public static class AndroidxSqliteLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
         ...
         * with version reference <b>androidx.sqlite</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class KotlinxIoLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>bytestring</b> with <b>org.jetbrains.kotlinx:kotlinx-io-bytestring</b> coordinates and
    ...
    public static class MultipazLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public MultipazLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>multipaz</b> with <b>org.multipaz:multipaz</b> coordinates and
         * with version reference <b>multipaz</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("multipaz");
        }

        /**
         * Dependency provider for <b>compose</b> with <b>org.multipaz:multipaz-compose</b> coordinates and
         * with version reference <b>multipaz</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("multipaz.compose");
        }

        /**
         * Dependency provider for <b>doctypes</b> with <b>org.multipaz:multipaz-doctypes</b> coordinates and
         * with version reference <b>multipaz</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getDoctypes() {
            return create("multipaz.doctypes");
        }

        /**
         * Dependency provider for <b>models</b> with <b>org.multipaz:multipaz-models</b> coordinates and
         * with version reference <b>multipaz</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getModels() {
            return create("multipaz.models");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ktor</b> with value <b>2.3.13</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>multipaz</b> with value <b>0.94.0-pre.17.8db0f9b7</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMultipaz() { return getVersion("multipaz"); }
    ...
    public static class AndroidxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidx.sqlite</b> with value <b>2.5.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KotlinxVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>kotlinx.io</b> with value <b>0.4.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
